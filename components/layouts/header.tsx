...
const Header = () => {
    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''} shadow-lg rounded-lg`}>
            <div className="shadow-sm rounded-md">
                <div className="relative flex rounded-md w-full items-center bg-white px-5 py-2.5 mt-3 dark:bg-black">
                        ...
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            ...
                            >
                                <div className="relative">
                                    <input
                                        type="text"
                                        className="peer border-none form-input bg-gray-100 placeholder:tracking-widest sm:bg-transparent ltr:pl-9 ltr:pr-9 ltr:sm:pr-4 rtl:pl-9 rtl:pr-9 rtl:sm:pl-4"
                                        placeholder="Search"
                                    />
